...
# Computing some statistics (Max,Min ..)
...
# Define Figure and Axes grids
# Preparing a Figure with 3 subplots (3 Rows, 1 Column)
...
# Writing Title and Labels to the respective Subplots
...
# Core function to be Invoked for Animation
def animate(i):
    ...
    # Ready to Loop through data frames for Animation
    # Here; The animation is for Line and Bar plots
	...
	# Display respective Year in the Plot	
	TEXT.set_text(Disp_template % (Years[i]))
	
	# Display the Total in the Plot when the animation reaches the last data frames
	if (i>=13):
...
# Save the animated figure as mp4 media
# Uncomment Line 151 to save if desired (optional)
#ani.save('Elephant-Sad-Story.mp4', writer='ffmpeg')

# Show the figure on the fly
plt.show()


# End of Elephant-Sad-Story.py
